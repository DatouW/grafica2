...
namespace Graphic3D
{
    public class Televisor 
    {
        ...
        {
            Parts.Add("pantalla", new Part(StandardGeometry.CreateCube(pantalla.X, pantalla.Y, pantalla.Z,Color.AliceBlue), new Vertex(Center.X, Center.Y,Center.Z)));
            Parts.Add("soporte", new Part(StandardGeometry.CreateCube(soporte.X, soporte.Y, soporte.Z,Color.AliceBlue), new Vertex(Center.X, Center.Y - (pantalla.Y/2 + soporte.Y / 2), Center.Z)));
        }
