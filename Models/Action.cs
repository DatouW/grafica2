...
namespace Graphic3D.Models
{
    public class Action
    {
        ...
        public virtual void Update(float time)
        {
            ...
            {
                //CalculatePosition();
                //float t = (CurrentTime + time) / Duration;

                //Vector3 currentPosition = Vector3.Lerp(startPosition, finalPosition, t);
                //Vector3 currentPosition = CalculateBezierCurve(startPosition,finalPosition,Duration,CurrentTime);
        ...
        {
            //Vx
            //float currentHorizontalPosition = initialHorizontalVelocity * CurrentTime;

            // Vy
            //float currentVerticalPosition = initialVerticalVelocity * CurrentTime - 0.5f * gravity * CurrentTime * CurrentTime;
